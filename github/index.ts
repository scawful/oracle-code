...
import { createOpencodeClient } from "@oracle-code/sdk"
...
function useShareUrl() {
  return isMock() ? "https://dev.oracle-code.ai" : "https://oracle-code.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.oracle-code.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.oracle-code.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
