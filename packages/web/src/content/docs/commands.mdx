...
Create `.oracle-code/command/test.md`:

```md title=".oracle-code/command/test.md"
---
...
You can add custom commands through the Oracle Code config or by creating markdown files in the `command/` directory.

---

### JSON

Use the `command` option in your Oracle Code [config](/docs/config):

```json title="oracle-code.jsonc" {4-12}
{
...
- Global: `~/.config/oracle-code/command/`
- Per-project: `.oracle-code/command/`

```markdown title="~/.config/oracle-code/command/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".oracle-code/command/component.md"
---
...
```md title=".oracle-code/command/create-file.md"
---
...
```md title=".oracle-code/command/analyze-coverage.md"
---
...
```md title=".oracle-code/command/review-changes.md"
---
...
```md title=".oracle-code/command/review-component.md"
---
...
oracle-code includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
