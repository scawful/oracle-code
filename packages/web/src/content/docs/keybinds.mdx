...
Oracle Code has a list of keybinds that you can customize through the Oracle Code config.
...
Oracle Code uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
