...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new OracleCodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class OracleCodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<OracleCodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    OracleCodeClient.__registry.set(this, args?.key)
  }
