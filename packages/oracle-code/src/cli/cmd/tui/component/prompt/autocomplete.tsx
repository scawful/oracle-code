...
export function Autocomplete(props: {
  ...
  const commands = createMemo((): AutocompleteOption[] => {
    ...
    // Helper to insert slash command text into prompt
    const insertSlashCommand = (cmd: string) => {
      const cursor = props.input().logicalCursor
      props.input().deleteRange(0, 0, cursor.row, cursor.col)
      props.input().insertText(cmd)
      props.input().cursorOffset = Bun.stringWidth(cmd)
    }
    ...
    results.push(
      ...
      {
        display: "/afs",
        description: "show AFS status",
        onSelect: () => insertSlashCommand("/afs"),
      },
      {
        display: "/plan",
        description: "manage plan.md",
        onSelect: () => insertSlashCommand("/plan"),
      },
      {
        display: "/state",
        description: "read/write shared state",
        onSelect: () => insertSlashCommand("/state"),
      },
      {
        display: "/memory",
        description: "search memory directory",
        onSelect: () => insertSlashCommand("/memory"),
      },
      {
        display: "/scratchpad",
        description: "manage scratchpad",
        onSelect: () => insertSlashCommand("/scratchpad"),
      },
      {
        display: "/knowledge",
        description: "search knowledge directory",
        onSelect: () => insertSlashCommand("/knowledge"),
      },
      {
        display: "/sync",
        description: "sync shared understanding",
        onSelect: () => insertSlashCommand("/sync"),
      },
      {
        display: "/context",
        description: "load context file",
        onSelect: () => insertSlashCommand("/context load "),
      },
      // Theory of Mind shortcuts
      {
        display: "/fact",
        description: "add fact to shared state",
        onSelect: () => insertSlashCommand("/fact "),
      },
      {
        display: "/assumption",
        description: "add assumption to shared state",
        onSelect: () => insertSlashCommand("/assumption "),
      },
      {
        display: "/goal",
        description: "add goal to shared state",
        onSelect: () => insertSlashCommand("/goal "),
      },
      {
        display: "/decision",
        description: "add decision to shared state",
        onSelect: () => insertSlashCommand("/decision "),
      },
      {
        display: "/uncertainty",
        description: "add uncertainty to shared state",
        onSelect: () => insertSlashCommand("/uncertainty "),
      },
      {
        display: "/note",
        description: "add note to scratchpad",
        onSelect: () => insertSlashCommand("/note "),
      },
      // Code & Files
      {
        display: "/diff",
        description: "show file changes",
        onSelect: () => insertSlashCommand("/diff"),
      },
      {
        display: "/focus",
        description: "focus on specific file",
        onSelect: () => insertSlashCommand("/focus "),
      },
      {
        display: "/search",
        description: "search codebase",
        onSelect: () => insertSlashCommand("/search "),
      },
      {
        display: "/git",
        description: "show git info",
        onSelect: () => insertSlashCommand("/git"),
      },
      {
        display: "/todo",
        description: "manage todos",
        onSelect: () => insertSlashCommand("/todo"),
      },
      // Info commands
      {
        display: "/config",
        description: "view configuration",
        onSelect: () => insertSlashCommand("/config"),
      },
      {
        display: "/whoami",
        description: "show current agent info",
        onSelect: () => insertSlashCommand("/whoami"),
      },
      {
        display: "/workspace",
        description: "show workspace info",
        onSelect: () => insertSlashCommand("/workspace"),
      },
      {
        display: "/retry",
        description: "retry last message",
        onSelect: () => insertSlashCommand("/retry"),
      },
    )
