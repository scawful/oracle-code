---
title: Share
description: Share your Oracle Code conversations.
---

Oracle Code's share feature allows you to create public links to your Oracle Code conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Oracle Code:
...
Oracle Code supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Oracle Code uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `oracle-code.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using oracle-code in your organization.
