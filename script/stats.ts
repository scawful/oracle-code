...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/scawful/oracle-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for scawful/oracle-code...\n")
...
console.log("Fetching npm all-time downloads for oracle-code-ai...\n")
const npmDownloads = await fetchNpmDownloads("oracle-code-ai")
