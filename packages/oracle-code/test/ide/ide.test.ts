...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OCODE_CALLER", () => {
    process.env["OCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OCODE_CALLER", () => {
    process.env["OCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OCODE_CALLER", () => {
    process.env["OCODE_CALLER"] = "unknown"
