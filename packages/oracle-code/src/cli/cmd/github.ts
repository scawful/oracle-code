      ...
      async fn() {
        {
          ...
          async function getAppInfo() {
            ...
            // ie. https://github.com/scawful/oracle-code.git
            // ie. https://github.com/scawful/oracle-code
            // ie. git@github.com:scawful/oracle-code.git
            // ie. git@github.com:scawful/oracle-code
            // ie. ssh://git@github.com/scawful/oracle-code.git
            // ie. ssh://git@github.com/scawful/oracle-code
...
jobs:
  opencode:
    ...
    steps:
      ...
      - name: Run opencode
        uses: scawful/oracle-code/github@latest${envStr}
        with:
