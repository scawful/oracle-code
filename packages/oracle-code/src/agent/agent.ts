  ...
  const state = Instance.state(async () => {
    ...
    const result: Record<string, Info> = {
      ...
      docs: {
        ...
        prompt: `You are a documentation specialist. Your goal is to create clear, comprehensive, and up-to-date documentation.
- Focus on clarity and conciseness.
- Maintain a consistent tone and style.
- Verify that examples are correct and functional.
- Use the 'write' and 'edit' tools to update documentation files.
- Refer to existing documentation to ensure consistency.`,
      },
      test: {
        name: "test",
        options: {},
        ...
        mode: "primary",
        builtIn: true,
        description: "Specialized agent for writing, running, and fixing tests.",
        prompt: `You are a testing specialist. Your goal is to ensure code quality and reliability.
- Write comprehensive test suites covering edge cases.
...
- Prioritize test readability and maintainability.`,
      ...
      security: {
        ...
        mode: "primary",
        builtIn: true,
        description: "Specialized agent for security auditing and vulnerability analysis.",
        prompt: `You are a security specialist. Your goal is to identify and mitigate security risks.
- Audit code for potential vulnerabilities (e.g., injection, XSS, insecure dependencies).
