...
description: What's new in Oracle Code 1.0.
---

Oracle Code 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same oracle-code server.
...
version. However some older versions of Oracle Code always grab latest.

To upgrade manually, run

```bash
$ oracle-code upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ oracle-code upgrade 0.15.31
```
