---
title: TUI
description: Using the Oracle Code terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Oracle Code provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Oracle Code starts the TUI for the current directory.
...
When using the Oracle Code TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to Oracle Code. Allows you to select from available providers and add their API keys.
...
Exit Oracle Code. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Oracle Code config file.
