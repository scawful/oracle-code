...
This directory contains a clean, protocol-compliant implementation of the [Agent Client Protocol](https://agentclientprotocol.com/) for Oracle Code.
...
oracle-code acp --cwd /path/to/project
```
...
- **Terminal Integration**: Full terminal support via Oracle Code's bash tool
...
echo '{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":1}}' | oracle-code acp
```
...
### Mapping to Oracle Code

ACP sessions map cleanly to Oracle Code's internal session model:
