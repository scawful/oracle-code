---
title: LSP Servers
description: Oracle Code integrates with your LSP servers.
---

Oracle Code integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

Oracle Code comes with several built-in LSP servers for popular languages:
...
When oracle-code opens a file, it:
...
You can customize LSP servers through the `lsp` section in your oracle-code config.
